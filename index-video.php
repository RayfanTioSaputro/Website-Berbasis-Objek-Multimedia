        ...
        <div id="page-content-wrapper">
            ...
            <div class="container">
                ...
                <div class="ml-3 mr-3">
                    <div class="row" style="margin-top: 28px;">
                        <div class="col-4">
                            <div class="card" style="width: 21rem;">
                                <a href="lg-fullscreen-video.php">
                                    <video controls class="card-img-top" src="videos/street.mp4" loop width="250" height="188"></video>
                                </a>
                    ...
                    <div class="row mb-5" style="margin-top: 28px;">
                        <div class="col-4">
                            <div class="card" style="width: 21rem;">
                                <a href="lg-fullscreen-video.php">
                                    <video controls class="card-img-top" src="videos/street.mp4" loop width="250" height="188"></video>
